...
public class Part1 extends Genericlaunch {

	public WebDriver driver;
	@Test
	public void test_login() throws InterruptedException {
		Part1 assessment = new Part1();
		...
		for (WebElement colors : ele) {
			...
			{
				Reporter.log("Gold is present");
			}
			else if (color.equals("rgb(42, 37, 89)")) 
			{
				Reporter.log("Navy is present");
			}
			else if (color.equals("rgb(147, 149, 152)")) 
			{
				Reporter.log("white is present");
			}
